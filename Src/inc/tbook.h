...
#define TB_audSent             EventID(EventLevelOp,     TBAud_no, 0x04)
...
#define TB_saiEvt              EventID(EventLevelOp,     TBsai_no, 0x04)
...
#define TB_saiSend             EventID(EventLevelAPI,    TBsai_no, 0x08)
